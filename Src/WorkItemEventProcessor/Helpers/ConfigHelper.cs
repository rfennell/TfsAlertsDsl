...
namespace TFSEventsProcessor.Helpers
{
    ...
    internal class ConfigHelper
    {
        ...
        internal static string GetLoggingPath()
        {
            ...
            if (string.IsNullOrEmpty(System.Configuration.ConfigurationManager.AppSettings["LoggingFolder"]) == false)
            {
                logFolder = System.Configuration.ConfigurationManager.AppSettings["LoggingFolder"];
            }
            return logFolder;
        }
