...
namespace TFSEventsProcessor.Tests
{
    ...
    /// </summary>
    [TestFixture]
    public class WorkItemChangedTests
    {
       [Test]
        public void Can_get_an_alert_change_field()
        {
            // arrange
            var alerts = TestData.DummyAlerts();
       ...
       [Test]
        public void User1_reassigns_WI_from_User2_to_self_mail_sent_to_user2()
        {
            ...
            var provider = TestProviderFactory.MockedTfsFieldLookupProvider("user1").Object;
            provider.SetChangedBy("user1");
            provider.SetTestAlertItems(TestData.AssignedToChangedAlerts("user2", "user1"));
       ...
       [Test]
        public void User1_reassigns_WI_User2_to_User3_mail_sent_to_both()
        {
            ...
            provider.SetChangedBy("user1");
            provider.SetTestAlertItems(TestData.AssignedToChangedAlerts("user2", "user3"));
