namespace TFSEventsProcessor.Tests
{
    ...
    /// </summary>
    [TestFixture]
    public class EmailTemplateAlertFieldTests
    {
        public EmailTemplateAlertFieldTests()
        {
       ...
       [Test]
        public void Process_template_with_two_alert_fields()
        {
            // arrange
            ...
            // Assert
            Assert.AreEqual("The title is System|Title for the System|ID", actual);
        }

       [Test]
        public void Process_template_with_one_alert_field_in_middle()
        {
            // arrange
            ...
            // Assert
            Assert.AreEqual("The title is System|Title for message", actual);
        }
       ...
       [Test]
        public void Process_template_with_one_alert_field_at_end()
        {
            // arrange
            ...
            // Assert
            Assert.AreEqual("The message is System|Title", actual);
        }
    }
}
